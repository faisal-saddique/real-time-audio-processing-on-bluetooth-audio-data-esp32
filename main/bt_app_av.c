...
/*  This is the standard callback function which is invoked as soon as the data
    is available from bluetooth source device. However, I have currently modified
    it by applying some biquad filters. Some help has been taken here from the 
    online resources. */
...
//     if (++s_pkt_cnt % 100 == 0) {
//         ESP_LOGI(BT_AV_TAG, "Faisal Jani! Audio packet count is %u", s_pkt_cnt);
//     }
// }
